  ...
  if seletor == 1: # seletor igual 1 com caracteristicas realizando a soma dos valores inseriodos 
    ...
    if num1 > num2:
      ...
      if num2 > num1:
        maior = num2
        print(' O numero {} é o numero maior'.format(maior))
  elif seletor == 5: # seletor igual 5 referente a opção de inserir novos dados para que novas operações sejam realizados
    print('Insira Novamente os numeros!')
    num1 = int(input('Digite o primeiro numero:'))
    num2 = int(input('Digite o segundo numero:')) 
  elif seletor == 6: # opção 6 refeente ao fim da condição while estabelida no inicio da condição e fechamento do programa 
