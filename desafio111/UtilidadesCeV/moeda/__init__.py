...
# adicionado ao modulo moeda dentro do pacote utilidadesCEV
'''
    criado um pacote chamado utilidadesCEV e todos os codigos 
    separados por um modulo chamado moeda dos codigos anteriores 
    foi separado dentro de um pacote com o mesmo nome do modulo anterior
    então para importar é necessario importar o pacote depois disso
    o modulo ou função especifica dos modulos ou modulo '''